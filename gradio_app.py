...
with gr.Blocks() as demo:
    with gr.Row():
        ...
        with gr.Column():
            ...
            reference= gr.Image(source="upload", type="numpy", shape=[256, 256], label="Reference image to imitate")
            ref_cond = gr.Number(value=0.0, label="Reference strength: higher values render images more similar to the provided reference")
    ...
    render_button.click(
        render_image,
        inputs=[text_input, steps, guidance, reference, ref_cond],
